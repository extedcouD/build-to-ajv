...
export default function init(input: validationInput): validationOutput {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_ID_18**: $.message.order.fulfillments[*].id must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_TYPE.2**: every element of $.message.order.fulfillments[*].type must be in ["Delivery", "Return", "RTO"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_GPS_30**: $.message.order.fulfillments[*].end.location.gps must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_31(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_31**: $.message.order.fulfillments[*].end.location.address.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BUILDING_32(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BUILDING_32**: $.message.order.fulfillments[*].end.location.address.building must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_33(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_33**: $.message.order.fulfillments[*].end.location.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_34(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_34**: $.message.order.fulfillments[*].end.location.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_35(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_35**: $.message.order.fulfillments[*].end.location.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNTRY_36(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNTRY_36**: $.message.order.fulfillments[*].end.location.address.country must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_37(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_37**: $.message.order.fulfillments[*].end.location.address.area_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_38(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_38**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_39**: $.message.order.billing.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_NAME_40(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_NAME_40**: $.message.order.billing.address.name must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_BUILDING_41(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_BUILDING_41**: $.message.order.billing.address.building must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_LOCALITY_42(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_LOCALITY_42**: $.message.order.billing.address.locality must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_CITY_43(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_CITY_43**: $.message.order.billing.address.city must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_STATE_44(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_STATE_44**: $.message.order.billing.address.state must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_COUNTRY_45(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_COUNTRY_45**: $.message.order.billing.address.country must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_AREA_CODE_46(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_AREA_CODE_46**: $.message.order.billing.address.area_code must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_PHONE_48(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_PHONE_48**: $.message.order.billing.phone must be present in the payload`,
                        },
                    ];
                }
        ...
        function REQUIRED_MESSAGE_EMAIL_49(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition REQUIRED_MESSAGE_EMAIL_49**: $.message.order.billing.email must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition REQUIRED_MESSAGE_TYPE_53.2**: every element of $.message.order.payment.type must be in ["ON-ORDER", "ON-FULFILLMENT", "POST-FULFILLMENT"]`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition VALID_ENUM_MESSAGE_TYPE_4**: every element of $.message.order.payment.type must be in ["ON-ORDER", "ON-FULFILLMENT", "POST-FULFILLMENT"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_2_linked_order**: every element of $.message.order.fulfillments[*].tags[?(@.code=='linked_order')].list[*].code must be in ["id", "currency", "declared_value", "category", "weight_unit", "weight_value", "dim_unit", "length", "breadth", "height"]`,
                        },
                    ];
                }
	...
	> - **condition B**: $.message.order.items[*].tags[*].code must **not** be present in the payload`,
        ...
        function validate_tag_3_type(input: validationInput): validationOutput {
            const scope = payloadUtils.getJsonPath(
                input.payload,
	...
	> - **condition B**: $.message.order.tags[*].code must **not** be present in the payload`,
        ...
        function init_fulfillment_id_validations(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
        ...
        const testFunctions: testFunctionArray = [
            ...
            REQUIRED_MESSAGE_NAME_31,
            REQUIRED_MESSAGE_BUILDING_32,
            REQUIRED_MESSAGE_LOCALITY_33,
            REQUIRED_MESSAGE_CITY_34,
            REQUIRED_MESSAGE_STATE_35,
            REQUIRED_MESSAGE_COUNTRY_36,
            REQUIRED_MESSAGE_AREA_CODE_37,
            REQUIRED_MESSAGE_PHONE_38,
            REQUIRED_MESSAGE_NAME_39,
            REQUIRED_MESSAGE_NAME_40,
            REQUIRED_MESSAGE_BUILDING_41,
            REQUIRED_MESSAGE_LOCALITY_42,
            REQUIRED_MESSAGE_CITY_43,
            REQUIRED_MESSAGE_STATE_44,
            REQUIRED_MESSAGE_COUNTRY_45,
            REQUIRED_MESSAGE_AREA_CODE_46,
            REQUIRED_MESSAGE_TAX_NUMBER,
            REQUIRED_MESSAGE_PHONE_48,
            REQUIRED_MESSAGE_EMAIL_49,
